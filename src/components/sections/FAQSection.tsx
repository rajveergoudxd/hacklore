...
export default function FAQSection() {
    ...
    return (
        <section id="faq" className="py-16 md:py-24 px-4 sm:px-6 md:px-12 lg:px-20 relative bg-[var(--background)]">
            ...
            <div className="max-w-[900px] mx-auto relative">
                ...
                <div className="text-center mb-10 md:mb-16">
                    ...
                    <ScrollReveal delay={0.1}>
                        <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mt-4 mb-4 md:mb-6">
                ...
                {/* Contact CTA */}
                <ScrollReveal delay={0.3} className="mt-8 md:mt-12 text-center">
                    <p className="text-white/60 mb-4 text-sm md:text-base">Still have questions?</p>
                    <motion.a
                        href="mailto:hello@hacklore.dev"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="inline-flex items-center gap-2 px-5 md:px-6 py-2.5 md:py-3 rounded-full glass-panel hover:border-[var(--primary)]/50 transition-colors text-sm md:text-base"
                    >
...
function FAQItem({
    ...
    return (
        <motion.div
            onClick={onClick}
            className={`
                rounded-xl md:rounded-2xl border transition-all duration-300 cursor-pointer overflow-hidden
                ${isOpen
        ...
        >
            <div className="p-4 md:p-6 flex items-center justify-between gap-3">
                <h3 className="text-sm md:text-lg font-medium pr-2">{question}</h3>
                <motion.div
